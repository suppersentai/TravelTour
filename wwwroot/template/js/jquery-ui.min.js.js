...
!(function (t) {
    ...
    (k.Widget.prototype = {
      ...
      option: function (t, e) {
        ...
        if ("string" == typeof t)
          if (((a = {}), (t = (i = t.split(".")).shift()), i.length)) {
            for (
              s = a[t] = k.widget.extend({}, this.options[t]), n = 0;
              n < i.length - 1;
              n++
            )
              (s[i[n]] = s[i[n]] || {}), (s = s[i[n]]);
      ...
      _on: function (n, a, t) {
        ...
        "boolean" != typeof n && ((t = a), (a = n), (n = !1)),
          t
            ? ((a = o = k(a)), (this.bindings = this.bindings.add(a)))
      ...
      return (
        ...
        this.each(function () {
          var i,
            ...
            h = k.extend({}, m),
            u = T(w.my, o.outerWidth(), o.outerHeight());
          "right" === c.my[0]
            ? (h.left -= r)
            : "center" === c.my[0] && (h.left -= r / 2),
            "bottom" === c.my[1]
              ? (h.top -= l)
            ...
            c.using &&
              (t = function (t) {
                ...
                p < r && D(e + i) < p && (a.horizontal = "center"),
                  f < l && D(s + n) < f && (a.vertical = "middle"),
                  x(D(e), D(i)) > x(D(s), D(n))
    ...
    (k.ui.position = {
      fit: {
        left: function (t, e) {
          ...
          e.collisionWidth > n
            ? 0 < o && r <= 0
              ? ((i = t.left + o + e.collisionWidth - n - s), (t.left += o - i))
              : (t.left =
                  !(0 < r && o <= 0) && r < o ? s + n - e.collisionWidth : s)
            : 0 < o
            ? (t.left += o)
            : 0 < r
            ? (t.left -= r)
        ...
        top: function (t, e) {
          ...
          e.collisionHeight > n
            ? 0 < o && r <= 0
              ? ((i = t.top + o + e.collisionHeight - n - s), (t.top += o - i))
              : (t.top =
                  !(0 < r && o <= 0) && r < o ? s + n - e.collisionHeight : s)
            : 0 < o
            ? (t.top += o)
            : 0 < r
            ? (t.top -= r)
      ...
      flip: {
        left: function (t, e) {
          var i = e.within,
            ...
            o = -2 * e.offset[0];
          r < 0
            ? ((s = t.left + h + i + o + e.collisionWidth - n - s) < 0 ||
                s < D(r)) &&
              (t.left += h + i + o)
            : 0 < l &&
              (0 <
                (a = t.left - e.collisionPosition.marginLeft + h + i + o - a) ||
                D(a) < l) &&
              (t.left += h + i + o);
        },
        top: function (t, e) {
          var i = e.within,
            ...
            o = -2 * e.offset[1];
          r < 0
            ? ((s = t.top + h + i + o + e.collisionHeight - n - s) < 0 ||
                s < D(r)) &&
              (t.top += h + i + o)
            : 0 < l &&
              (0 <
                (a = t.top - e.collisionPosition.marginTop + h + i + o - a) ||
                D(a) < l) &&
              (t.top += h + i + o);
        },
      },
  ...
  k.widget("ui.draggable", k.ui.mouse, {
    ...
    k.ui.plugin.add("draggable", "scroll", {
      ...
      drag: function (t, e, i) {
        ...
        a !== o && "HTML" !== a.tagName
          ? ((s.axis && "x" === s.axis) ||
              (i.overflowOffset.top + a.offsetHeight - t.pageY <
              s.scrollSensitivity
                ? (a.scrollTop = n = a.scrollTop + s.scrollSpeed)
                : t.pageY - i.overflowOffset.top < s.scrollSensitivity &&
                  (a.scrollTop = n = a.scrollTop - s.scrollSpeed)),
            (s.axis && "y" === s.axis) ||
              (i.overflowOffset.left + a.offsetWidth - t.pageX <
              s.scrollSensitivity
                ? (a.scrollLeft = n = a.scrollLeft + s.scrollSpeed)
                : t.pageX - i.overflowOffset.left < s.scrollSensitivity &&
                  (a.scrollLeft = n = a.scrollLeft - s.scrollSpeed)))
          : ((s.axis && "x" === s.axis) ||
              (t.pageY - k(o).scrollTop() < s.scrollSensitivity
                ? (n = k(o).scrollTop(k(o).scrollTop() - s.scrollSpeed))
                : k(window).height() - (t.pageY - k(o).scrollTop()) <
                    s.scrollSensitivity &&
                  (n = k(o).scrollTop(k(o).scrollTop() + s.scrollSpeed))),
            (s.axis && "y" === s.axis) ||
              (t.pageX - k(o).scrollLeft() < s.scrollSensitivity
                ? (n = k(o).scrollLeft(k(o).scrollLeft() - s.scrollSpeed))
          ...
          (l =
            ...
            !k.contains(
              ...
              : ("inner" !== d.snapMode &&
                ...
                (i.snapElements[v].snapping = s || n || a || o || c));
      },
    }),
        ...
        for (e in ((t = t || this.element), this.handles))
          this.handles[e].constructor === String
            ...
            : (this.handles[e].jquery || this.handles[e].nodeType) &&
              ...
              this._on(this.handles[e], { mousedown: o._mouseDown })),
            this.elementIsWrapper &&
        ...
        this._helper &&
          ((s =
            (e =
              ...
              ? 0
              : a.sizeDiff.height),
          (i = e ? 0 : a.sizeDiff.width),
          (e = { width: a.helper.width() - i, height: a.helper.height() - s }),
          (i =
    ...
    k.ui.plugin.add("resizable", "containment", {
        ...
        o &&
          ...
          /document/.test(a) || a === document
            ...
            : ((i = k(o)),
              ...
              (e = n._hasScroll(o) ? o.scrollHeight : e),
              (n.parentData = {
                element: o,
                left: t.left,
                top: t.top,
      ...
      stop: function () {
        ...
        t._helper &&
          ...
          k(this).css({ left: o.left - s.left - i.left, width: r, height: a }),
          t._helper &&
            !e.animate &&
        ...
        (i.grid = r),
          ...
          /^(se|s|e)$/.test(o)
            ...
            : ((p - h <= 0 || d - l <= 0) &&
              ...
              0 < p - h
                ? ((e.size.height = p), (e.position.top = a.top - c))
                : ((p = h - t.height),
                  (e.size.height = p),
                  (e.position.top = a.top + n.height - p)),
              0 < d - l
                ? ((e.size.width = d), (e.position.left = a.left - u))
                : ((d = l - t.width),
                  (e.size.width = d),
                  (e.position.left = a.left + n.width - d)));
      },
    });
  k.ui.resizable,
      ...
      _eventHandler: function (t) {
        ...
        t.preventDefault(),
          (n && !e.collapsible) ||
            ...
            ((e.active = !a && this.headers.index(s)),
            (this.active = n ? k() : s),
            this._toggle(o),
            this._removeClass(
              i,
        ...
        return (
          ...
          i.length
            ? t.length
              ...
              : i.animate(this.hideProps, a, n, h)
            : t.animate(this.showProps, a, n, h)
        );
      },
  ...
  k.widget("ui.controlgroup", {
    ...
    _initWidgets: function () {
      ...
      k.each(this.options.items, function (s, t) {
        ...
        if (t)
          return "controlgroupLabel" === s
            ? ((e = a.element.find(t)).each(function () {
              ...
              void (o = o.concat(e.get())))
            : void (
                k.fn[s] &&
                ((n = a["_" + s + "Options"]
                  ? a["_" + s + "Options"]("middle")
                  : { classes: {} }),
        ...
        (this.childWidgets = k(k.unique(o))),
      ...
      this._addClass(
        ...
        n.length &&
          (k.each(["first", "last"], function (t, e) {
            ...
            s && a["_" + s.widgetName + "Options"]
              ? (((i = a["_" + s.widgetName + "Options"](
                  1 === n.length ? "only" : e
                )).classes = a._resolveClassesValues(i.classes, s)),
    ...
    k.extend(m.prototype, {
      ...
      _autoSize: function (t) {
        ...
        this._get(t, "autoSize") &&
          ...
          (o = this._get(t, "dateFormat")).match(/[DM]/) &&
            ((e = function (t) {
      ...
      _dialogDatepicker: function (t, e, i, s, n) {
        ...
        return (
          o ||
            ...
            k.data(this._dialogInput[0], "datepicker", o)),
          b(o.settings, s || {}),
      ...
      _doKeyDown: function (t) {
        ...
        if (((s._keyEvent = !0), k.datepicker._datepickerShowing))
          switch (t.keyCode) {
            ...
            case 37:
              (t.ctrlKey || t.metaKey) &&
                k.datepicker._adjustDate(t.target, a ? 1 : -1, "D"),
                (n = t.ctrlKey || t.metaKey),
                t.originalEvent.altKey &&
                  k.datepicker._adjustDate(
                    t.target,
      ...
      parseDate: function (e, n, t) {
        ...
        if (u < n.length && ((l = n.substr(u)), !/^\s+/.test(l)))
        ...
        if ((j < 0 && ((j += 12), K--), q))
          for (
            e = this._daylightSavingAdjust(
              new Date(
                q.getFullYear(),
                q.getMonth() - F[0] * F[1] + 1,
                q.getDate()
              )
            ),
              e = Y && e < Y ? Y : e;
            this._daylightSavingAdjust(new Date(K, j, 1)) > e;
        ...
        for (
          t.drawMonth = j,
            ...
            R = W
              ? this.formatDate(
                  R,
                  this._daylightSavingAdjust(new Date(K, j - O, 1)),
                  this._getFormatConfig(t)
                )
              : R,
            i = this._canAdjustMonth(t, -1, K, j)
            ...
            R = W
              ...
              : R,
            s = this._canAdjustMonth(t, 1, K, j)
            ...
            R = this._get(t, "gotoCurrent") && t.currentDay ? B : H,
            N = W ? this.formatDate(N, R, this._getFormatConfig(t)) : N,
            W = t.inline
              ? ""
          ...
          for (_ = "", this.maxRows = 4, v = 0; v < F[1]; v++) {
            if (
              ((b = this._daylightSavingAdjust(new Date(K, j, t.selectedDay))),
              (x = " ui-corner-all"),
              (y = ""),
              L)
            ) {
            ...
            for (
              y += w + "</tr></thead><tbody>",
                D = this._getDaysInMonth(K, j),
                K === t.selectedYear &&
                  j === t.selectedMonth &&
                  (t.selectedDay = Math.min(t.selectedDay, D)),
                x = (this._getFirstDayOfMonth(K, j) - n + 7) % 7,
                D = Math.ceil((x + D) / 7),
                C = L && this.maxRows > D ? this.maxRows : D,
                this.maxRows = C,
                T = this._daylightSavingAdjust(new Date(K, j, 1 - x)),
                M = 0;
              M < C;
              M++
            ) {
              for (
                ...
                (S = u ? u.apply(t.input ? t.input[0] : null, [T]) : [!0, ""]),
                  (z =
                    ((P = T.getMonth() !== j) && !d) ||
                    !S[0] ||
                    (Y && T < Y) ||
      ...
      _mouseCapture: function (t) {
        ...
        return (
          ...
          !1 !== this._start(t, a) &&
            ...
            n.trigger("focus"),
            (e = n.offset()),
            (o = !k(t.target).parents().addBack().is(".ui-slider-handle")),
            (this._clickOffset = o
              ? { left: 0, top: 0 }
              : {
  ...
  k.widget("ui.tabs", {
      ...
      (this.tablist = this._getList().attr("role", "tablist")),
        ...
        this.anchors.each(function (t, e) {
          ...
          l._isLocal(e)
            ...
            : ((i =
                "#" + (n = o.attr("aria-controls") || k({}).uniqueId()[0].id)),
            ...
            o.attr({ "aria-controls": n, "aria-labelledby": a }),
    ...
    _eventHandler: function (t) {
      var e = this.options,
        ...
        i = { oldTab: i, oldPanel: r, newTab: a ? k() : s, newPanel: o };
      t.preventDefault(),
  ...
  k.widget("ui.tooltip", {
    ...
    _open: function (t, e, i) {
      var s,
        n,
        a,
        o = k.extend({}, this.options.position);
      function r(t) {
    ...
    return (
      ...
      W(O, function (t, e) {
        ...
        if (i)
          return (
            (i = n[e](i)),
            (n[A[e].cache] = i[A[e].cache]),
            (a = n._rgba = i._rgba),
            !1
          );
      }),
      a.length
        ? ("0,0,0,0" === a.join() && I.extend(a, P.transparent), n)
        : P[s]
    );
  }
  function tt(t, e, i) {
  ...
  (k.effects = { effect: {} }),
    ...
    (at = I("<p>")[0]),
    (W = I.each),
    (at.style.cssText = "background-color:rgba(1,1,1,.5)"),
    (N.rgba = -1 < at.style.backgroundColor.indexOf("rgba")),
    W(A, function (t, e) {
      (e.cache = "_" + t),
        (e.props.alpha = { idx: 3, type: "percent", def: 1 });
    }),
    (H.fn = I.extend(H.prototype, {
      parse: function (n, t, e, i) {
        if (n === S) return (this._rgba = [null, null, null, null]), this;
        (n.jquery || n.nodeType) && ((n = I(n).css(t)), (t = S));
        var a = this,
          s = I.type(n),
          o = (this._rgba = []);
        return (
          t !== S && ((n = [n, t, e, i]), (s = "array")),
          "string" === s
            ? this.parse(Z(n) || P._default)
            : "array" === s
            ? (W(A.rgba.props, function (t, e) {
                o[e.idx] = Q(n[e.idx], e);
              }),
              this)
            : "object" === s
                ...
                n instanceof H
                  ...
                  : function (t, i) {
                      ...
                      W(i.props, function (t, e) {
                        ...
                        a[s] &&
                          I.inArray(null, a[s].slice(0, 3)) < 0 &&
    ...
    (A.hsla.from = function (t) {
      ...
      var e = t[0] / 360,
        ...
        s = 2 * s - i;
      return [
        Math.round(255 * tt(s, i, e + 1 / 3)),
        Math.round(255 * tt(s, i, e)),
        Math.round(255 * tt(s, i, e - 1 / 3)),
        t,
      ];
    }),
    W(A, function (l, t) {
      var a = t.props,
        ...
        h = t.from;
      (H.fn[l] = function (t) {
        if ((r && !this[o] && (this[o] = r(this._rgba)), t === S))
          return this[o].slice();
        var e,
          i = I.type(t),
        ...
        return (
          W(a, function (t, e) {
            ...
            null == t && (t = n[e.idx]), (n[e.idx] = Q(t, e));
          }),
          h ? (((e = H(h(n)))[o] = n), e) : H(n)
        );
      }),
        W(a, function (o, r) {
          H.fn[o] ||
            (H.fn[o] = function (t) {
              ...
              return "undefined" === i
                ? a
                : ("function" === i && ((t = t.call(this, a)), (i = I.type(t))),
                  null == t && r.empty
                    ? this
                    : ("string" === i &&
                        (e = z.exec(t)) &&
            ...
            if ("transparent" !== e && ("string" !== I.type(e) || (i = Z(e)))) {
              if (((e = H(i || e)), !N.rgba && 1 !== e._rgba[3])) {
                for (
                  ...
                  try {
                    (n = I.css(s, "backgroundColor")), (s = s.parentNode);
                  } catch (t) {}
      ...
      function (t, e) {
        k.fx.step[e] = function (t) {
          (("none" !== t.end && !t.setAttr) || (1 === t.pos && !t.setAttr)) &&
            (J.style(t.elem, e, t.end), (t.setAttr = !0));
        };
      }
    ),
    k.fn.addBack ||
      ...
      return this.queue(function () {
        var i = k(this),
          ...
          e = (e = a.children ? i.find("*").addBack() : i).map(function () {
            return { el: k(this), start: et(this) };
          }),
          s = function () {
            k.each(B, function (t, e) {
              n[e] && i[e + "Class"](n[e]);
            });
          };
        s(),
    ...
    k.fn.extend({
      effect: function () {
        ...
        function h(t) {
          var e = k(this);
          function i() {
            k.isFunction(o) && o.call(e[0]), k.isFunction(t) && t();
          }
          (s.mode = l.shift()),
            !1 === k.uiBackCompat || a
              ? "none" === s.mode
      ...
      show:
        ((U = k.fn.show),
        function (t) {
          if (st(t)) return U.apply(this, arguments);
      ...
      hide:
        ((K = k.fn.hide),
        function (t) {
          if (st(t)) return K.apply(this, arguments);
          var e = it.apply(this, arguments);
      ...
      toggle:
        ((j = k.fn.toggle),
        function (t) {
          if (st(t) || "boolean" == typeof t) return j.apply(this, arguments);
          var e = it.apply(this, arguments);
      ...
      transfer: function (t, e) {
        var i = k(this),
          ...
          s = i.offset(),
          l = k("<div class='ui-effects-transfer'></div>")
            .appendTo("body")
  ...
  k.effects.define("blind", "hide", function (t, e) {
    ...
    (o.clip[i[n][0]] = o.clip[i[n][1]]),
      "show" === t.mode &&
        (s.cssClip(o.clip), r && r.css(k.effects.clipToBox(o)), (o.clip = a)),
    ...
    k.effects.define("bounce", function (t, e) {
      ...
      for (
        ...
        ((i = {})[p] = (f ? "-=" : "+=") + h),
          ...
          (h = o ? 2 * h : h / 2);
      o &&
        (((i = { opacity: 0 })[p] = (f ? "-=" : "+=") + h), n.animate(i, c, d)),
        n.queue(e),
        k.effects.unshift(n, t, 1 + a);
    }),
    ...
    k.effects.define("drop", "hide", function (t, e) {
      ...
      k.effects.createPlaceholder(i),
        (n =
          t.distance || i["top" == a ? "outerHeight" : "outerWidth"](!0) / 2),
        (l[a] = o + n),
        s && (i.css(l), (l[a] = r + n), (l.opacity = 1)),
        i.animate(l, {
          queue: !1,
          duration: t.duration,
          easing: t.easing,
    ...
    k.effects.define("explode", "hide", function (t, e) {
      ...
      function m() {
        g.push(this),
          g.length === l * h &&
            (u.css({ visibility: "visible" }), k(g).remove(), e());
      }
      for (i = 0; i < l; i++)
        for (a = d.top + i * f, r = i - (l - 1) / 2, s = 0; s < h; s++)
          (n = d.left + s * p),
            (o = s - (h - 1) / 2),
            u
              .clone()
    ...
    k.effects.define("fold", "hide", function (e, t) {
      ...
      r && (o = (parseInt(r[1], 10) / 100) * f[a ? 0 : 1]),
        ...
        (p.clip[l[1]] = 0),
        n &&
          (i.cssClip(p.clip), u && u.css(k.effects.clipToBox(p)), (p.clip = c)),
        i
          .queue(function (t) {
            u &&
              u
    ...
    k.effects.define("size", function (s, e) {
      ...
      k.effects.createPlaceholder(i),
        ...
        ("box" !== h && "both" !== h) ||
          (n.from.y !== n.to.y &&
            ((f = k.effects.setTransition(i, a, n.from.y, f)),
            (g = k.effects.setTransition(i, a, n.to.y, g))),
          n.from.x !== n.to.x &&
            ((f = k.effects.setTransition(i, o, n.from.x, f)),
            (g = k.effects.setTransition(i, o, n.to.x, g)))),
        ("content" !== h && "both" !== h) ||
          (n.from.y !== n.to.y &&
            ((f = k.effects.setTransition(i, t, n.from.y, f)),
            (g = k.effects.setTransition(i, t, n.to.y, g)))),
        u &&
          ((u = k.effects.getBaseline(u, p)),
          (f.top = (p.outerHeight - f.outerHeight) * u.y + d.top),
          (f.left = (p.outerWidth - f.outerWidth) * u.x + d.left),
          (g.top = (p.outerHeight - g.outerHeight) * u.y + d.top),
          (g.left = (p.outerWidth - g.outerWidth) * u.x + d.left)),
        i.css(f),
        ("content" !== h && "both" !== h) ||
          ...
          i.find("*[width]").each(function () {
            ...
            n.from.y !== n.to.y &&
              ((i = k.effects.setTransition(t, a, n.from.y, i)),
              (e = k.effects.setTransition(t, a, n.to.y, e))),
              n.from.x !== n.to.x &&
                ((i = k.effects.setTransition(t, o, n.from.x, i)),
                (e = k.effects.setTransition(t, o, n.to.x, e))),
              l && k.effects.saveStyle(t),
              t.css(i),
              t.animate(e, s.duration, s.easing, function () {
                l && k.effects.restoreStyle(t);
              });
          })),
        i.animate(g, {
          queue: !1,
          ...
          complete: function () {
            ...
            0 === g.opacity && i.css("opacity", f.opacity),
              l ||
                (i.css("position", "static" === c ? "relative" : c).offset(t),
                k.effects.saveStyle(i)),
              e();
          },
        });
    ...
    k.effects.define("pulsate", "show", function (t, e) {
      ...
      for (
        ...
        i.animate({ opacity: r }, o, t.easing), (r = 1 - r);
      i.animate({ opacity: r }, o, t.easing),
        i.queue(e),
        k.effects.unshift(i, s, 1 + a);
    }),
  ...
  !1 !== k.uiBackCompat &&
    (at = k.effects.define("transfer", function (t, e) {
      k(this).transfer(t, e);
    }));
});
